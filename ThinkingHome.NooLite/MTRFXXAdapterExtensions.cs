...
public static class MTRFXXAdapterExtensions
{
    ...
    private static Tuple<MTRFXXMode, MTRFXXAction> GetModeAndAction(bool useFMode, uint? deviceId)
    {
    ...
    private static void Send(MTRFXXAdapter adapter, MTRFXXCommand command, bool useFMode, byte channel = 0,
        uint? deviceId = null)
    {
    ...
    private static void SendData(MTRFXXAdapter adapter, MTRFXXCommand command, bool useFMode, byte channel,
        uint? deviceId, MTRFXXDataFormat format, params byte[] data)
    {
        var ma = GetModeAndAction(useFMode, deviceId);

        adapter.SendCommand(ma.Item1, ma.Item2, channel, command, MTRFXXRepeatCount.NoRepeat, format, data,
            deviceId ?? 0);
    }
    ...
    public static void OnF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
    ...
    public static void OffF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
    ...
    public static void SwitchF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
    ...
    public static void TemporarySwitchOn(this MTRFXXAdapter adapter, byte channel, ushort interval)
    {
        var b1 = (byte)interval;
        var b2 = (byte)(interval >> 8);
        var format = b2 == 0
    ...
    public static void TemporarySwitchOnF(this MTRFXXAdapter adapter, byte channel, ushort interval,
        uint? deviceId = null)
    {
        var b1 = (byte)interval;
        var b2 = (byte)(interval >> 8);
    ...
    public static void SetBrightnessF(this MTRFXXAdapter adapter, byte channel, byte brightness, uint? deviceId = null)
    {
        SendData(adapter, MTRFXXCommand.SetBrightness, true, channel, deviceId, MTRFXXDataFormat.OneByteData,
            brightness);
    }
    ...
    public static void SavePresetF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
    ...
    public static void LoadPresetF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
    ...
    {
        SendData(adapter, MTRFXXCommand.SetBrightness, false, channel, null, MTRFXXDataFormat.FourByteData, valueR,
            valueG, valueB);
    }

    public static void SetLedColorF(this MTRFXXAdapter adapter, byte channel, byte valueR, byte valueG, byte valueB,
        uint? deviceId = null)
    {
        SendData(adapter, MTRFXXCommand.SetBrightness, true, channel, deviceId, MTRFXXDataFormat.FourByteData, valueR,
            valueG, valueB);
    }
    ...
    public static void SwitchColorChangingF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
    ...
    public static void ChangeLedColorF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
    ...
    public static void ChangeLedColorModeF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
    ...
    public static void ChangeLedColorSpeedF(this MTRFXXAdapter adapter, byte channel, uint? deviceId = null)
    {
